      ...
      <div>
        <Divider speed={0.2} offset={0} factor={1}>
          <UpDown>
            ...
            <Svg icon="box" width={6} color="icon_darkest" left="60%" top="15%" />
          </UpDown>
          <UpDownWide>
            <Svg icon="arrowUp" hiddenMobile width={16} color="icon_darkest" left="80%" top="10%" />
            <Svg icon="triangle" width={12} stroke color="icon_darkest" left="90%" top="50%" />
            <Svg icon="circle" width={16} color="icon_darkest" left="70%" top="90%" />
            <Svg icon="triangle" width={16} stroke color="icon_darkest" left="30%" top="65%" />
            <Svg icon="cross" width={16} stroke color="icon_darkest" left="28%" top="15%" />
            <Svg icon="circle" width={6} color="icon_darkest" left="75%" top="10%" />
            <Svg icon="upDown" hiddenMobile width={8} color="icon_darkest" left="45%" top="10%" />
          </UpDownWide>
          <Svg icon="circle" hiddenMobile width={24} color="icon_darkest" left="5%" top="70%" />
