...
<ProjectCard
  title="QERQWRE Tips & Tricks for Gatsby"
...
<ProjectCard
  title="QERQWRE Setting  up a yarn Workspace"
...
<ProjectCard
  title="QERQWRE Adding a Draft Feature to Gatsby"
...
<ProjectCard
  title="QERQWRE Theme UI Plugin for Figma"
